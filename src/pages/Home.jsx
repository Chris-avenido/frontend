...
const Home = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, color, delay, loading }) => {
    ...
    return (
      <motion.div
        ...
        className="relative overflow-hidden bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/60 flex flex-col justify-between group h-[140px]"
      >
        ...
        <div className="relative z-10 flex items-center justify-between mb-4">
          ...
          <div className={`p-2.5 rounded-xl bg-gradient-to-br ${color} text-white shadow-sm`}>
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row font-sans relative overflow-hidden">
      <Sidebar />
      <main className="flex-1 p-6 md:p-10 lg:p-12 pb-24 md:pb-10 h-screen overflow-y-auto z-10 relative custom-scrollbar">
